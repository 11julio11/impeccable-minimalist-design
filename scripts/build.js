...
async function build() {
  ...
  if (BUILD_OPTIONS.syncRootOutputs) {
    ...
    const claudeSkillsSrc = path.join(DIST_DIR, 'claude-code', '.claude', 'skills', 'design-minimalist');
    if (fs.existsSync(claudeSkillsSrc)) {
      fs.mkdirSync(pluginSkillsDir, { recursive: true });
      copyDirSync(claudeSkillsSrc, path.join(pluginSkillsDir, 'design-minimalist'));
    }
