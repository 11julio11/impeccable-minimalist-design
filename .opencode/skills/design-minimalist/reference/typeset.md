...
```bash
node .opencode/skills/design-minimalist/scripts/detect.mjs --json --scope type [target files or dirs]
```
...
When the hierarchy holds, hand off to `/Minimalist Design polish`.
