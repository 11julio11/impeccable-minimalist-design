...
CLI scan:
```bash
node .agents/skills/design-minimalist/scripts/detect.mjs --json [target]
```
...
4. **Read the trend** for context:
   ```bash
   node .agents/skills/design-minimalist/scripts/critique-storage.mjs trend "<resolved target>" 5
   ```
