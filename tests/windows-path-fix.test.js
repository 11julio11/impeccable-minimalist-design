...
describe('Windows path doubling fix (#95)', () => {
  test('fileURLToPath strips leading slash from Windows file URLs', () => {
    ...
    const winUrl = new URL('file:///C:/Users/foo/core/detector/detect-antipatterns.mjs');

    // Raw .pathname returns '/C:/Users/foo/core/detector/detect-antipatterns.mjs'
    expect(winUrl.pathname).toBe('/C:/Users/foo/core/detector/detect-antipatterns.mjs');
  ...
  test('fileURLToPath handles POSIX file URLs correctly', () => {
    const posixUrl = new URL('file:///home/user/core/detector/detect-antipatterns.mjs');
    const resolved = fileURLToPath(posixUrl);
    expect(resolved).toBe('/home/user/core/detector/detect-antipatterns.mjs');
  });
