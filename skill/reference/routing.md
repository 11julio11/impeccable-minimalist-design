...
Read this when the user invokes `{{command_prefix}}Minimalist Design` with no argument. They are asking "what should I do?" Make the menu context-aware instead of static.
