...
```bash
node .opencode/skills/design-minimalist/scripts/detect.mjs --json --scope layout [target files or dirs]
```
...
When the structure holds, hand off to `/Minimalist Design polish`.
